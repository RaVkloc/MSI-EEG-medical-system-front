  ...
  render = () => {
    return(
      <div className="bg-content">
        ...
        <form onSubmit={this.login} className={'login_form'}>
          <label className={'login_label'}>
            ...
            <div className={'input-container'}>
              <p className={'margin-right'}>Username:</p><input className={'input' + (this.state.error ? ' invalid' : '')} type="text" value={this.state.login} onChange={this.changeLogin} />
            </div>
            <div className={'input-container'}>
        ...
        <p className={'register '}>Not registered yet? <a className={'register-active'} onClick={this.register}>Sign up!</a></p>
      </div>
    )
  }
}
